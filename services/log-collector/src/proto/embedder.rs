        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/embedder.Embedder/EmbedLog",
            );
            let mut req = request.into_streaming_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("embedder.Embedder", "EmbedLog"));
...
pub mod embedder_server {
    ...
    pub trait Embedder: std::marker::Send + std::marker::Sync + 'static {
        /// Server streaming response type for the EmbedLog method.
        type EmbedLogStream: tonic::codegen::tokio_stream::Stream<
        ...
        async fn embed_log(
            ...
            >,
        ) -> std::result::Result<tonic::Response<Self::EmbedLogStream>, tonic::Status>;
    }
    #[derive(Debug)]
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/embedder.Embedder/EmbedLog" => {
                    ...
                    struct EmbedLogSvc<T: Embedder>(pub Arc<T>);
                    impl<
                        T: Embedder,
                    ...
                    > for EmbedLogSvc<T> {
                        ...
                        type ResponseStream = T::EmbedLogStream;
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as Embedder>::embed_log(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    pub const SERVICE_NAME: &str = "embedder.Embedder";
